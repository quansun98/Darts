...
RcppExport SEXP _Darts_dnorm_cpp(SEXP xSEXP, SEXP meanSEXP, SEXP sdSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _Darts_rdarts_post_pr_cpp(SEXP parSEXP, SEXP dataSEXP, SEXP tauSEXP, SEXP sigmaSEXP, SEXP is_pairedSEXP, SEXP inc_eff_lenSEXP, SEXP skp_eff_lenSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _Darts_rdarts_posterior_MCMC_sampler(SEXP NSEXP, SEXP tauSEXP, SEXP sigmaSEXP, SEXP dataSEXP, SEXP init_valSEXP, SEXP proposal_widthSEXP, SEXP burninSEXP, SEXP thinningSEXP, SEXP random_stateSEXP, SEXP is_pairedSEXP, SEXP inc_eff_lenSEXP, SEXP skp_eff_lenSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _Darts_darts_likelihood_cpp(SEXP muSEXP, SEXP deltaSEXP, SEXP dataSEXP, SEXP loglikSEXP, SEXP inc_eff_lenSEXP, SEXP skp_eff_lenSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _Darts_set_seed(SEXP seedSEXP) {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _Darts_darts_posterior_MCMC_sampler(SEXP NSEXP, SEXP tauSEXP, SEXP dataSEXP, SEXP init_valSEXP, SEXP proposal_widthSEXP, SEXP burninSEXP, SEXP thinningSEXP, SEXP random_stateSEXP, SEXP inc_eff_lenSEXP, SEXP skp_eff_lenSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< int >::type N(NSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    {"_Darts_dnorm_cpp", (DL_FUNC) &_Darts_dnorm_cpp, 3},
    {"_Darts_rdarts_post_pr_cpp", (DL_FUNC) &_Darts_rdarts_post_pr_cpp, 7},
    {"_Darts_rdarts_posterior_MCMC_sampler", (DL_FUNC) &_Darts_rdarts_posterior_MCMC_sampler, 12},
    {"_Darts_darts_likelihood_cpp", (DL_FUNC) &_Darts_darts_likelihood_cpp, 6},
    {"_Darts_set_seed", (DL_FUNC) &_Darts_set_seed, 1},
    {"_Darts_darts_posterior_MCMC_sampler", (DL_FUNC) &_Darts_darts_posterior_MCMC_sampler, 10},
    {NULL, NULL, 0}
};

RcppExport void R_init_Darts(DllInfo *dll) {
